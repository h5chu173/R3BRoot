...
InitStatus R3BBunchedFiberCal2Hit::Init()
{
  ...
  //std::cout << "Hist was created" << endl;
...
*/
  ...
  //std::cout << "Hist has been filled" << endl;
  if(s_mult>0){
